...
class AdminReportedFoundItems extends StatefulWidget {
  static String id = 'admin_reported_found_items';

  @override
  _AdminReportedFoundItemsState createState() =>
      _AdminReportedFoundItemsState();
}

class _AdminReportedFoundItemsState extends State<AdminReportedFoundItems> {
                            ...
                            Align(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (confirm) {
                                    await foundItems.doc(item.id).delete();
